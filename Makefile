BUILD_DIR=./build
SRCS_CMD := 24_cmd_cat.asm 25_cmd_bs02.asm 27_snake.asm 28_sudoku.asm 28_sudoku_ui.asm 29_template.asm 29_pcm.asm
...
BINS_CMD := $(BUILD_DIR)/24_cmd_cat $(BUILD_DIR)/25_cmd_bs02 $(BUILD_DIR)/27_snake $(BUILD_DIR)/28_sudoku $(BUILD_DIR)/29_template $(BUILD_DIR)/29_pcm
